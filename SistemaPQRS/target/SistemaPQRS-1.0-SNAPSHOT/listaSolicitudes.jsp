                    ...
                    <tbody>
                        <%
                            ...
                            try {
                                ...
                                String sql = "SELECT s.IdSolicitud, s.Titulo, s.Mensaje, u.Nombre_usuario AS NombreUsuario, ts.tipo AS TipoSolicitud, s.Fecha, s.ruta_archivo, s.Estado, u.Correo AS CorreoUsuario "
                                        + "FROM Solicitud s "
