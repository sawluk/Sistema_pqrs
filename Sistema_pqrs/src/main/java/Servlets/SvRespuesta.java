...
public class SvRespuesta extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int IdSolicitud = Integer.parseInt("IdSolicitud");
        // Aquí puedes hacer lo que necesites con la respuesta, como almacenarla en la base de datos o procesarla de alguna otra manera
